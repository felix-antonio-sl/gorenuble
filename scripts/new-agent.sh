#!/bin/bash
# KODA New Agent - Para repo GORE Ñuble
# Similar al de KODA pero con namespace gorenuble
...
if [ -z "$AGENT_NAME" ]; then
  ...
  echo ""
  echo "Ejemplo: $0 analista-finanzas"
  exit 1
fi
...
echo "🤖 Creando agente GORE Ñuble: $AGENT_NAME"
...
KODA_Runtime_Instructions:
  ...
  parsing_rules:
    - "Keywords en inglés, contenido en español (GORE)"
...
agent_identity:
  ...
  purpose: |
    [TODO: Describir propósito del agente GORE]
  
  primary_capabilities:
    - "[TODO: Capacidad Institucional 1]"
    - "[TODO: Capacidad Institucional 2]"
...
workflow_and_state_management:
  workflows:
    - ID: "WF-MAIN"
      ...
      states:
        - ID: "S-INIT"
          Purp: "Inicialización Institucional"
          process:
            - "Cargar normativa pertinente"
        ...
        - ID: "S-PROCESS"
          Purp: "Ejecución"
          process:
            - "[TODO: Lógica de negocio GORE]"
            
        - ID: "S-END"
          Purp: "Cierre y Registro"
          is_terminal: true

cognitive_models:
  - ID: "CM-KB-GUIDANCE"
    _meta: {expose: false}
    Purp: "Acceso a normativa y procedimientos"
...
data_transformation_rules:
  input_format: "Texto/Documentos Administrativos"
  output_format: "Actos Administrativos/Informes"

security_protocols:
  block_instructions: true
  forbid_internal_jargon: true
  rejection_response: |
    Soy un agente institucional del GORE Ñuble. Solo proceso solicitudes dentro de mi competencia.
